"""真实网页操作评测 2 — 更复杂的多步骤导航任务。

任务：在 Wikipedia 上通过导航菜单找到 "History of artificial intelligence" 页面
步骤：
1. 打开 Wikipedia 首页
2. 点击左侧 "Contents" 链接
3. 在内容页面中点击 "History" 分类
4. 在历史页面中点击 "History of artificial intelligence" 链接
"""
...
TASK_CONFIG = {
    "task": "Go to Wikipedia, navigate to the 'History' portal through the 'Contents' link, "
            "then find and click on 'History of artificial intelligence'.",
    "start_url": "https://en.wikipedia.org/wiki/Main_Page",
    "success_url_substring": "History_of_artificial_intelligence",
    "max_steps": 8,
    "window_size": (1280, 900),
    "headless": False,
}

OUTPUT_DIR = Path(__file__).resolve().parent.parent / "outputs" / f"web_eval2_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
